(() => {
  ...
  let sigilButtons = document.querySelectorAll(".sigilContainer"),
    ...
    after the death of Lyanna Stark.`],
    ...
    he royal House following the destruction of the Great Sept of Baelor.`],
    ...
    subsequent assassination of all the male Freys soon after.`]
